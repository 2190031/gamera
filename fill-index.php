                                ...
                                while ($rowZ = $result->fetch_assoc()) {
                                    echo "<input id='$rowZ[id]' type='radio' value='" . $rowZ['content'] . "' name='helpDoc' onchange='showTitleAndCont(`" . $rowZ['title'] . "`, this.value)' hidden>
                                        ...
                                        <div class='btn-group btn-sm float-end'>
                                            <button type='button' title='Editar contenido' href='#title' class='btn btn-outline-dark btn-sm float-end' id='scroll-nav-btn' onclick='editCont(`" . $rowZ['id'] . "`, `" . $rowZ['title'] . "`, 0, `" . $rowZ['content'] . "`)'>
