    ...
    <div class="general">
        ...
        <div class="contenido" id="conten">
            ...
            <section class="box" id="contenido">
              ...
              <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi sapiente natus, corrupti dolore dolorem doloremque. Accusantium, placeat velit! Sit accusamus ipsa rem a vel exercitationem tempora sequi voluptatem nobis adipisci! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, omnis sunt eius commodi quae repellat reprehenderit amet, recusandae ab eos odit in, eveniet nam veniam obcaecati doloribus ad dignissimos soluta?</p> <br>

              <h2>AYUDA</h2>

              <p>Esta es la seccion de ayuda, aqui podra ver el funcionamiento de cada elemento del sistema. Tiene un indice a su izquierda que lo llevara a la ayuda que necesite, de igual forma, habra un buscador en la parte superior derecha para buscar cosas mas especificas.</p>
              <br>
              ...
              <li><span class="caret"><a href="#" class="ola2">Administracion</a></span>
                <ul class="nested">
                  ...
                  <li><span class="caret"><a href="#" class="ola">Archivos</a></span>
                      <ul class="nested">
                          <li><a href="#" id="05" class="ola">-Archivos Generales</a></li>
                          ...
                          <li><span class="caret"><a href="#" class="ola">¿Como?</a></span>
                              <ul class="nested">
                                  ...
                                  <li><a href="#" class="ola">-¿Como agregar los tipos de ajustes para utilizar en el cuadre?</a></li>
                              </ul>
                          </li>
                      </ul>
                  </li>
                      ...
                      <ul class="nested">
                          ...
                          <li><span class="caret"><a href="#" class="ola">¿Como?</a></span>
                              <ul class="nested">
                                  ...
                                  <li><a href="#" class="ola">-¿Como se cambia el estado de un prestamo para el buro del credito?</a></li>
                              </ul>
                          </li>
                      </ul>
                  </li>
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
            ...
            <p><i class="fas fa-phone me-3"></i>+1 809 276 2410</p>
          </div>
          <!-- Grid column -->
        </div>
        <!-- Grid row -->
